...
import { AlertTriangle, CheckCircle, ExternalLink, LineChart, MessageSquareText, 
  Quote, Users, BarChartHorizontal } from "lucide-react";
import { FaDiscord, FaGithub, FaRedditAlien, FaTelegram, FaXTwitter } from "react-icons/fa6";

// --- Research-Based Community Metrics ---
const metrics = [
    { 
      icon: Users, 
      value: "Target: 10k+", 
      ...
      trend: "Starting Soon", 
      description: "Join our growing Telegram, Discord, and Twitter communities. Be among the first to participate!", 
      color: "blue", 
      prelaunch: true 
    },
    { 
      ...
      trend: "Initial Feedback Positive", 
      description: "We'll measure and report community sentiment post-launch. Early adopter feedback guides our path.", 
      color: "green", 
      prelaunch: true 
    },
    { 
      ...
      value: "Goal: 5k+", 
      label: "First Month Holders", 
      trend: "Launch Pending", 
      description: "We're targeting a strong initial holder base to build network effects and distribution.", 
      color: "orange", 
      prelaunch: true 
    },
];

// --- Anticipated Testimonials (Pre-Launch) ---
const testimonials = [
    { 
      name: "Crypto Enthusiast", 
      handle: "@example_user1", 
      avatarFallback: "CE", 
      image: "/placeholder-avatars/solana-sensei.png", 
      text: "Impressed by $ROACH's antifragile concept. Dynamic tax adaptation during market volatility could be game-changing if implemented properly.", 
      role: "Example Feedback", 
      verified: false, 
      prelaunch: true 
    },
    { 
      name: "DeFi Investor", 
      handle: "@example_user2", 
      avatarFallback: "DI", 
      image: "/placeholder-avatars/defi-degen.png", 
      text: "The cockroach concept is brilliant for crypto. A token designed to benefit from chaos instead of just surviving it. Will be watching the audit and LP lock closely.", 
    ...
    { 
      ...
      handle: "@example_user3", 
      avatarFallback: "SD", 
      image: "/placeholder-avatars/crypto-cassie.png", 
      text: "The technical approach looks solid on paper. Eager to see how the tier system functions in practice and whether it can truly deliver on the antifragile promise.", 
...
// --- Social Links to Main Platforms ---
const socialLinks = [
...
// Color map helper for consistent theming
const colorMap = {
                        ...
                        return (
                            <motion.div key={index} variants={itemVariants}>
                                <Card className={cn(
                                    ...
                                    metric.prelaunch && "bg-muted/20 dark:bg-muted/10 border-dashed"
                                )}>
                    ...
                    >
                        <div className="relative aspect-[16/5] bg-muted/20 dark:bg-white/5 border border-dashed border-border/30 rounded-lg p-3 flex items-center justify-center">
                            <p className="text-xs text-muted-foreground/70 italic max-w-md text-center">
                                AI Prompt: Visualize community growth metrics with a three-section chart showing projected community members, sentiment tracking, and holder acquisition targets over time. Include upward trend lines and interactive data points indicating key milestones.
                                <span className="block mt-1 text-[10px] tracking-wider font-medium uppercase text-muted-foreground/50">
                                    Research: Social Proof - Cialdini's Principles - Network Effect Visualization
                                </span>
                            </p>
                        </div>
                    </motion.div>
                    ...
                    <Card className="inline-block border border-border/20 dark:border-border/25 bg-gradient-to-br from-card via-muted/10 to-card rounded-xl">
                        <CardContent className="space-y-4">
                            ...
                            <div className="flex flex-wrap justify-center gap-3 sm:gap-4 pt-2">
                                {socialLinks.filter(link => link.href !== '#').slice(0, 3).map(link => (
