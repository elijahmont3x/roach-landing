...
const marketScenarios = [
    { id: 'stable', label: "Stable Market", icon: Activity, description: "Balanced buy/sell activity with equal market participation, similar to SOL's periods of consolidation.", roach: { tier: 2, priceImpact: "Stable Orbit", rewardLevel: "Standard", sentiment: "Neutral", outcome: "Baseline operations. Reflections accrue steadily at 4% from sell tax. System maintains equilibrium and builds long-term holder value." }, resilient: { priceImpact: "Stable", rewardLevel: "None/Fixed", sentiment: "Neutral", outcome: "Systems like $IMG maintain static 3% reflection rates. No adaptive mechanisms engaged, missing opportunities to build reserves." }, color: "gray" },
    { id: 'dip', label: "Minor Dip", icon: ChevronsDown, description: "Moderate increase in selling pressure (10-20%), similar to BTC's typical 5-10% correction phases.", roach: { tier: 3, priceImpact: "Dip Cushioned", rewardLevel: "Increased", sentiment: "Opportunistic", outcome: "Higher sell tax (9%) applied, increasing holder reflection pool to 6%. Buy tax reduced to 4%, encouraging new entries. Early defensive positioning outperforms static systems." }, resilient: { priceImpact: "Noticeable Dip", rewardLevel: "None/Fixed", sentiment: "Slight Concern", outcome: "Tokens like $BONK with unchanging tokenomics follow market trend downward. Fixed 3-5% mechanisms continue regardless of pressure, missing adaptation opportunity." }, color: "yellow" },
    { id: 'selloff', label: "Significant Sell-off", icon: TrendingDown, description: "Strong selling volume (20-40% price drop), comparable to ETH's reaction during broader market downturns.", roach: { tier: 4, priceImpact: "Defense Activated", rewardLevel: "High", sentiment: "Confident / Contrarian", outcome: "Sharp sell tax increase to 12% heavily disincentivizes panic selling, boosting reflections to 8%. Lower 3% buy tax encourages strategic entry. Reward mechanisms strengthen holder loyalty exactly when needed most." }, resilient: { priceImpact: "Sharp Drop", rewardLevel: "None/Fixed", sentiment: "Anxious", outcome: "Static tokens like PEPE or DOGE drop significantly with market. Fixed tax rate systems (e.g., 5% regardless of conditions) fail to disincentivize selling or reward holders through volatility." }, color: "orange" },
    { id: 'crash', label: "Market Crash", icon: ShieldAlert, description: "Extreme panic selling (40%+ drops), similar to the March 2023 banking crisis or major regulatory FUD events.", roach: { tier: 5, priceImpact: "Antifragile Advantage*", rewardLevel: "Maximum", sentiment: "Strengthened / Strategic", outcome: "Peak sell tax (15%) & reflections (10%) convert market chaos into maximum holder rewards. Lowest buy tax (2%) creates ideal entry conditions. Project benefits from volatility rather than being harmed by it." }, resilient: { priceImpact: "Severe Drop", rewardLevel: "None/Fixed", sentiment: "Distressed", outcome: "Most tokens experience catastrophic value erosion. Many 'pump.fun' style tokens collapse entirely. Even established projects with static mechanisms (e.g., fixed 4-5% rates) see overwhelming sell pressure with nothing to counterbalance." }, color: "red" },
];
